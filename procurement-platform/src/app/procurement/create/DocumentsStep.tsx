...
export default function DocumentsStep({
  ...
  const [documentType, setDocumentType] = useState<DocumentType>('tender_specification');
  ...
  const documentTypes: { value: DocumentType; label: string }[] = [
    ...
    { value: 'financial_offer', label: 'Financial Template' },
  ...
  const addDocument = () => {
    ...
    setDocumentType('tender_specification');
    setIsPublic(true);
  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-4 rounded-md">
        <h3 className="text-sm font-medium text-blue-800 mb-1">Tender Documents</h3>
        <p className="text-sm text-blue-700">
          Upload documents that will be available to potential bidders.
          These documents provide detailed information about the tender requirements.
        </p>
      </div>
        ...
        <div className="mb-4">
          <div className="flex items-center">
            ...
            <label htmlFor="isPublic" className="ml-2 block text-sm text-gray-700">
              Make document publicly available to all potential bidders
            </label>
          </div>
        </div>
        ...
        {formData.documents.length === 0 ? (
          <div className="bg-gray-50 p-6 text-center rounded-md">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Upload documents to provide detailed information to bidders.
            </p>
          </div>
        ) : (
