...
export default function Footer() {
  return (
    <footer className="bg-[#0056a4] text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/tenders" className="text-gray-200 hover:text-white transition-colors text-sm">
                  Tenders
                </Link>
              </li>
              <li>
                <Link href="/submit-proposal" className="text-gray-200 hover:text-white transition-colors text-sm">
                  Submit Proposal
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/terms" className="text-gray-200 hover:text-white transition-colors text-sm">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-gray-200 hover:text-white transition-colors text-sm">
                  Cookies Policy
                </Link>
              </li>
            </ul>
        ...
        {/* Copyright */}
        <div className="mt-12 pt-8 border-t border-blue-400 text-center text-gray-200 text-sm">
