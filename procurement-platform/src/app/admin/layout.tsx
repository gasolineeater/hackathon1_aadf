      ...
      <div className="lg:hidden">
                ...
                <nav className="mt-5 px-2 space-y-1">
                  {navigation.map((item) => (
                    <Link
                      ...
                      className={`${
                        pathname === item.href
                          ? 'bg-gray-100 text-[#0056a4]'
                          : 'text-gray-600 hover:bg-gray-50 hover:text-[#0056a4]'
                      } group flex items-center px-2 py-2 text-base font-medium rounded-md`}
                    >
                      <svg
                        className={`${
                          pathname === item.href ? 'text-[#0056a4]' : 'text-gray-400 group-hover:text-[#0056a4]'
                        } mr-4 h-6 w-6`}
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
        ...
        <div className="flex items-center justify-between h-16 bg-white px-4 border-b border-gray-200">
          ...
          <div className="flex-1 flex justify-center lg:justify-start">
            <span className="text-xl font-bold text-[#0056a4] lg:hidden">AADF Admin</span>
          </div>
        </div>
      </div>
