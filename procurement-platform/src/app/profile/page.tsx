...
export default function Profile() {
  const { user, updateProfile, signOut, isEmailVerified, resendVerificationEmail } = useAuth();
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>Your email address has not been verified yet. Some features may be limited until you verify your email.</p>
                  </div>
                  <div className="mt-4">
                    <MicroButton
                      variant="secondary"
